...
function Swipe(container, options) {
  ...
  function setup() {
    ...
    width = container.getBoundingClientRect().width / options.items || container.offsetWidth;
