...
scarey.fastclick =  {
    ...
    go: function() {
        $.getScript('http://scarey.org/assets/js/libs/fastClick.js', function() {
...
scarey.colorbox = {
    init: function() {
        ...
        if ( matchMedia(scarey.medium).matches) {
            $.getScript('http://scarey.org/assets/js/libs/colorbox.js', function() {
                scarey.colorbox.go();
            });
            //this.go();
        } else {
...
scarey.photoGrid = function() {
    ...
    function fetchImages() {
        ...
        var request = $.ajax({
            url: 'http://scarey.org/assets/php/instagram.php',
            type: 'POST',
            data: ({
                count: count,
                max_id: max_id
